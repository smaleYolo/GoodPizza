...
import {clearCartItems, selectCart} from "../redux/slices/cartSlice";
...
const Cart = () => {
    ...
    // const {setPathName} = useContext(SearchContext)
    //return () => в useeffect срабатывает на момент componentDidUnmount
    // useEffect(() => {
    ...
    if (!totalCount) {
        return (
            <InfoBlock
                ...
                description='Вероятней всего, вы не заказывали ещё пиццу.
            ...
            <div className="container container--cart">
                <div className="cart">
                    <div className="cart__top">
                        ...
                        {cartItems.length > 0 && <div className="cart__clear" onClick={onClickClear}>
