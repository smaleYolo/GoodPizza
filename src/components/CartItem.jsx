...
import {addCartItem, removeCartItem, removeCartPizzas} from "../redux/slices/cartSlice";
...
const CartItem = ({id,title, price, imageUrl, count, type, size}) => {
    ...
    const onClickRemove = () => {
        if(window.confirm('Вы уверены, что хотите убрать данную пиццу из заказа?')){
            dispatch(removeCartPizzas({id}))
        }
    }
